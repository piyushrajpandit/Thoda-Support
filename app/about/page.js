...
const About = () => {
    return (
        <div className="container mx-auto px-8 md:px-4 py-8">
            <h1 className="text-3xl font-semibold mb-4">About Thoda Support</h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="flex items-center mb-6">
                    <img className="w-20 h-20 rounded-full mr-4 object-cover" src="/group.webp" alt="Fans Want to Collaborate" />
                    <div>
                ...
                <div className="flex items-center mb-6">
                    <img className="w-20 h-20 rounded-full mr-4 object-cover" src="/coin.webp" alt="Support Through Chai" />
                    <div>
